import { getPedido, getPedidoPorCod, postPedido, putPedidoPorCod, deletePedidoPorCod, getPedidosPorCliente } from '../controllers/pedido.controller.js'
...
routes.get('/cliente/:ci', verificarToken, getPedidosPorCliente)
